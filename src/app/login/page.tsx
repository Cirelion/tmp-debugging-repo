  ...
  return (
    <div className="login-card-wrapper">
      <div className="login-header">
        ...
        <p className="login-subtitle">Sign in to continue to Unstability</p>
      </div>
      ...
      <div className="login-card">
        <div className="login-form">
          ...
          >
            {loading === "discord" ? (
              <div className="button-spinner white" />
            ) : (
          ...
          >
            {loading === "google" ? (
              <div className="button-spinner gray" />
            ) : (
      ...
      <div className="back-home-container">
        <Link href="/" className="back-home-link">
          <svg className="back-home-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
              strokeWidth={2}

...
export const worker = await Nextjs("website", {
  ...
  bindings: {
    ...
    // Direct URLs for Prisma migrations (bypasses pooling)
    AUTH_DATABASE_URL: authDb.connection_uris[0].connection_uri,
    PRIMARY_DATABASE_URL: primaryDb.connection_uris[0].connection_uri,
  },
})
